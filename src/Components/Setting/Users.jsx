...
const Users = () => {
  ...
  const data = Array.from({ length: 50 }, (_, index) => ({
    ...
    status: ( <button className={`px-2 py-1 rounded mt-2 ${index % 3 === 0 ? 'bg-green-500' : 'bg-gray-500'} text-white`}>
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="flex justify-between items-center pb-3">
       ...
       <h1 className="text-2xl font-semibold pb-2 text-gray-700">
        ...
        <p className="text-xl text-gray-400">This features is not avalaible on the demo version</p>
       </div>
